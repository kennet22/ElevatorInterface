...
public class elevatorInterface_KennetThurman extends PApplet {
...
public void setLabel(IFButton button, String label){
  button.setLabel(label);
  redraw();
}

public int changeFloorRoutine(int floor, int destination){
  ...
  public void settings() {  size(120, 420); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "elevatorInterface_KennetThurman" };
    if (passedArgs != null) {
